...
Revision ID: b95029212150
Revises: 
Create Date: 2025-07-12 13:11:00.873145
...
def upgrade():
    ...
    with op.batch_alter_table('fornecedor', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_fornecedor_cnpj'), ['cnpj'], unique=True)
        batch_op.create_index(batch_op.f('ix_fornecedor_nome_fantasia'), ['nome_fantasia'], unique=False)
    ...
    sa.Column('criado_em', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('numero_processo', 'ano', name='_numero_ano_processo_uc')
    )
    ...
    sa.ForeignKeyConstraint(['fornecedor_id'], ['fornecedor.id'], name='fk_ata_fornecedor_id'),
    ...
    sa.ForeignKeyConstraint(['fornecedor_id'], ['fornecedor.id'], name='fk_contratinho_fornecedor_id'),
    sa.ForeignKeyConstraint(['processo_id'], ['processo.id'], ),
    ...
    sa.ForeignKeyConstraint(['fornecedor_id'], ['fornecedor.id'], name='fk_empenho_fornecedor_id'),
    sa.ForeignKeyConstraint(['processo_id'], ['processo.id'], ),
...
def downgrade():
    ...
    with op.batch_alter_table('fornecedor', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_fornecedor_nome_fantasia'))
